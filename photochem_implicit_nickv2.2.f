...
c &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
c time step control
        If (it.gt. 1) Then  ! once the initial ringing has died out
          dtime = 1000.*kyr
...
c check this vs spreadsheet - not the same
        ...
        H2_esc = -A_escape*Sun(2)*SSX*(fH2/(1+2.3*fH2))
     $     /sqrt(1 + B_escape*(Sun(2)*SSX)**2*BBB)
C        H2_esc = -A_escape*Sun(2)*SSX*(fH2/(1))
C     $     /sqrt(1 + B_escape*(Sun(2)*SSX)**2*BBB)
