...
gfortran test.o EvolveAtmFort.o HCN_transport.o dpmpar.o \
         enorm.o fdjac2.o lmdif.o lmdif1.o lmdif2.o \
         lmpar.o qrfac.o qrsolv.o -o test.run $FCFLAGS -llapack

python -m numpy.f2py -c src/HCN_transport.f90 src/EvolveAtmFort.f90 src/minpack/dpmpar.f src/minpack/enorm.f \
